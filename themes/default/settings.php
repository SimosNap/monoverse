            ...
            <div class="mv-admin-settings-section">
                ...
                <div class="mv-admin-field">
                    ...
                    <label for="site_theme">
                        <?= htmlspecialchars(
                            $t('admin.settings.brand.theme.label'),
                            ENT_QUOTES,
                            'UTF-8'
                        ) ?>
                    </label>
                    ...
                    <span class="mv-admin-field-help">
                        <?= htmlspecialchars(
                            $t('admin.settings.brand.theme.help'),
                            ENT_QUOTES,
                            'UTF-8'
                        ) ?>
                    </span>
                ...
                <div class="mv-admin-field">
                    ...
                    <label class="admin-checkbox">
                        ...
                        <span>
                            <?= htmlspecialchars(
                                $t('admin.settings.brand.header_text.label'),
                                ENT_QUOTES,
                                'UTF-8'
                            ) ?>
                        </span>
                    ...
                    <span class="mv-admin-field-help">
                        <?= htmlspecialchars(
                            $t('admin.settings.brand.header_text.help'),
                            ENT_QUOTES,
                            'UTF-8'
                        ) ?>
                    </span>
