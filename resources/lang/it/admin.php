...
return [
	...
	'faq' => [
		'title' => 'FAQ',
		'description' => 'Gestisci le domande frequenti pubblicate nella pagina FAQ.',
		...
		'empty' => [
			'title' => 'Nessuna FAQ creata',
			'description' => 'Crea la prima domanda frequente da pubblicare nella pagina FAQ.',
		],
		...
		'confirm' => [
			'delete' => 'Eliminare definitivamente questa FAQ?',
		],
	],
	'faq_form' => [
		'title' => [
		...
		'description' => 'Configura domanda, risposta, permalink e organizzazione della FAQ.',
		'back' => 'Torna alle FAQ',
		...
		'fields' => [
			...
			'anchor' => [
				'label' => 'Anchor',
				'help' => 'Identificatore stabile usato nel permalink. Evita di modificarlo dopo la pubblicazione.',
			],
			...
			'sort_order' => [
				'label' => 'Ordine',
				'help' => 'Le FAQ con valore più basso vengono mostrate prima.',
			],
		],
		...
		'permalink' => [
			'title' => 'Permalink',
			'description' => 'Ogni FAQ dispone di un collegamento diretto tramite anchor.',
		],

		'organization' => [
			'title' => 'Organizzazione',
			'description' => 'Raggruppa le FAQ per sezione e definisci stato e ordine di visualizzazione.',
		],
