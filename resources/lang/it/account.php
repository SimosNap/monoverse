...
return [
	...
	'events' => [
		...
		'subtitle' => 'Controlla lo stato degli eventi che hai proposto alla community.',
		'submit' => 'Proponi un evento',

		'empty' => 'Non hai ancora proposto nessun evento.',
	...
	'event_edit' => [
		...
		'event' => [
			'title' => 'Evento',
			'help' => 'Modifica le informazioni principali della proposta.',
		],

		'details' => [
			'title' => 'Dettagli',
			'help' => 'Aggiorna date, posizione e immagine dell’evento.',
		],
		...
		'fields' => [
			...
			'cover' => 'Cover',
			'cover_replace_help' => 'Carica una nuova immagine solo se vuoi sostituire la cover attuale.',
			'cover_default_help' => 'JPEG, PNG o WebP.',
		],
