...
return [
	...
	'settings' => [
		...
		'navigation' => [
			...
			'description' => 'Choose which sections are shown in the site main navigation menu.',
			'ping' => 'Show Ping',
			'members' => 'Show Members',
			'chanzine' => 'Show Chanzine',
			'events' => 'Show Events',
			'faq' => 'Show FAQ',
			'help' => 'Hiding an item from the menu does not disable the related site section.',
		],
	...
	'faq' => [
		'title' => 'FAQ',
		'description' => 'Manage the frequently asked questions published on the FAQ page.',
		...
		'empty' => [
			'title' => 'No FAQ created',
			'description' => 'Create the first frequently asked question to publish on the FAQ page.',
		],
		...
		'confirm' => [
			'delete' => 'Permanently delete this FAQ?',
		],
	],
	'faq_form' => [
		'title' => [
		...
		'description' => 'Configure the question, answer, permalink and organization of the FAQ.',
		'back' => 'Back to FAQ',
		...
		'fields' => [
			...
			'anchor' => [
				'label' => 'Anchor',
				'help' => 'Stable identifier used in the permalink. Avoid changing it after publication.',
			],
			...
			'sort_order' => [
				'label' => 'Order',
				'help' => 'FAQ entries with lower values are displayed first.',
			],
		],
		...
		'permalink' => [
			'title' => 'Permalink',
			'description' => 'Each FAQ has a direct link using its anchor.',
		],

		'organization' => [
			'title' => 'Organization',
			'description' => 'Group FAQ entries by section and define their status and display order.',
		],
